    ...
    <main className={styles.main}>
      <section>
        ...
        <div className={styles.main_ingredientBlock + " custom-scroll"}>
          <BurgerIngredients
            setIsOpen={setIsOpen}
            setClickIngredient={setClickIngredient}
            setImageIngredient={setImageIngredient}
      ...
      <section className={styles.main_constructorBlock + " pt-25 pl-4"}>
        ...
        <div
          className={styles.main_constructorMidleBlock + " custom-scroll pr-2"}
        >
